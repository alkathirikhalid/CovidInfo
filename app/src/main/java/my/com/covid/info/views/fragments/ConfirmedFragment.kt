...
import my.com.covid.info.databinding.ChartsFragmentBinding
...
class ConfirmedFragment : Fragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun create(countryName: String) = ConfirmedFragment().apply {
    ...
    override fun onCreateView(
        ...
        binding = ChartsFragmentBinding.inflate(layoutInflater, container, false)
    ...
    private fun fetchData() {
        ...
        viewModel.fetchHistoryData(countryName, ApiRepository.TYPE_CONFIRMED)
    }
    ...
    private fun setupCharts() {
        val chartstitle = "Covid Active Cases"
